...
import PIL
from pyscreeze import RGB, pixel
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            ...
            if event.key == K_g:
                ...
                finalgifset[0].save(f"{file}{file_extension}", save_all=True, append_images=finalgifset[1:], duration=20, loop=0)
